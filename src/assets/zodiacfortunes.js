const zodiacFortunes = {
  ...
  dog: [
    "After a challenging astrological clash in 2024, you may emerge from your kennel triumphant and ready to find a new and loyal master, in the form of a new career position or partnership that puts you more on an equal footing. If you find yourself being challenged by a lawsuit or anything of a legal nature, take heart, as you will most probably emerge the victor. You have several lucky stars in your chart, which help quell any ill luck of the past year.",
    <br />,
    <br />,
    "These will attract some rather nice people who admire you and your principles. Be cautious about communications with certain individuals, especially those closest to you who may have shown their true colours. It may be time to step away and change direction. It's time for positive changes in all aspects of your life - love is in the air.",
    <br />,
    <br />,
    "Lucky Animal Friend: Horse",
    <br />,
    "Best Months to Clean: February, March, June, August, September, October",
  ],
  pig: [
    "As you are the Snake's nemesis, this may be a challenging year after a good run of luck since 2023. Think things through and be willing to take advice available to you before making major decisions, otherwise the luck available to you could dissolve. You may feel impatient and edgy with many in 2025, however avoid getting too entangled in other issues as you may end up left out of some potentially good deals.",
    <br />,
    <br />,
    "Avoid being stubborn and be willing to eat a little humble pie, as this will go a long way to dispelling some uncomfortable moments. It is also advised that you visit the temple to receive blessings and protection as you are deemed to be offending the god of the year, aka Tai Sui. Shedding a little blood such as by having your teeth cleaned before the end of April is a form of self-protection against accidents and injuries. Be charitable and kind to seek greater spiritual support.",
    <br />,
    <br />,
    "Lucky Animal Friend: Monkey",
    <br />,
    "Best Months to Clean: February, March, April, June, September",
  ],
};
